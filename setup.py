...
<<<<<<< HEAD
	py_modules = [ "wishbone.main", "wishbone.server", "wishbone.wishbone", "wishbone.toolkit", "wishbone.tools.estools", "wishbone.tools.mongotools", "wishbone.io_modules.broker", "wishbone.io_modules.udpserver", "wishbone.io_modules.namedpipe", "wishbone.io_modules.socketfile", "wishbone.modules.skeleton", "wishbone.modules.jsonvalidator", "wishbone.modules.compressor", "wishbone.modules.stdout", "wishbone.modules.nagiosspoolwriter" ] )
=======
	py_modules = [ "wishbone.server.parallelserver", "wishbone.main", "wishbone.toolkit", "wishbone.tools.configure_logging", "wishbone.tools.estools", "wishbone.tools.mongotools", "wishbone.io_modules.broker", "wishbone.io_modules.udpserver", "wishbone.io_modules.namedpipe", "wishbone.io_modules.socketfile", "wishbone.modules.skeleton", "wishbone.modules.jsonvalidator", "wishbone.modules.compressor", "wishbone.modules.stdout", "wishbone.modules.nagiosspoolwriter" ] )
