...
.. code-block:: sh
    ...
    [smetj@dev-container ~]$ wishbone start -h
...
.. code-block:: sh
    ...
    [smetj@dev-container ~]$ wishbone debug -h
...
.. code-block:: sh
    ...
    smetj@dev-container ~]$ wishbone stop -h
...
.. code-block:: sh
    ...
    [smetj@dev-container ~]$ wishbone kill -h
...
.. code-block:: sh
    ...
    [smetj@dev-container ~]$ wishbone list
              __       __    __
    .--.--.--|__.-----|  |--|  |--.-----.-----.-----.
    |  |  |  |  |__ --|     |  _  |  _  |     |  -__|
...
.. code-block:: sh
    ...
    [smetj@dev-container ~]$ wishbone show --module wishbone.flow.fanout
              __       __    __
    .--.--.--|__.-----|  |--|  |--.-----.-----.-----.
    |  |  |  |  |__ --|     |  _  |  _  |     |  -__|
    |________|__|_____|__|__|_____|_____|__|__|_____|
