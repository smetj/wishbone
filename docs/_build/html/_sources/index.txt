...
Wishbone is a gevent based framework which simplifies writing modular message passing code by connecting the in- and outbox queues of multiple modules into a clean workflow.
...
By connecting the in- and outbox queues of all modules you create a clear modular data flow.

Wishbone comes with a set of modules which can be divided into 2 categories IO modules and regular modules.
