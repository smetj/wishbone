...
================
    ...
    *Wishbone is all about making the development of custom modules as simple
...
The docstring (line 8-36) contains the module's description.  It's encouraged
to document your module similarly.  The content of the docstring can be
...
:py:class:`wishbone.Actor` as a base class.
